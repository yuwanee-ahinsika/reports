...
export default function InventoryHeader({ activeTab, filter, setFilter, title, description }) {
    return (
        <div className="bg-white border border-slate-200 rounded-2xl p-6 mb-8 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-100">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-555 text-slate-500 text-xs mt-1">{description}</p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 self-end md:self-center">
                    ...
                    <a 
                        href={route('reports.inventory.export-word', { filter })} 
            ...
            <div className="flex flex-wrap items-center gap-2 mt-4 pt-1">
                ...
                >
                    ...
                    <span>Stock & Requisition Logs</span>
                </Link>
            </div>
        </div>
    );
